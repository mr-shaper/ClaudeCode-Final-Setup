...
echo "   --------------------------------------------------------"
echo "🔑 MAIN API CONFIGURATION (Required):"
echo "   1. Open ~/.zshrc in your editor (e.g., 'nano ~/.zshrc')"
echo "   2. Find the 'Claude Code 账号配置' section."
echo "   3. Replace 'sk-YOUR_OPENAI_API_KEY_HERE' with your actual Kimi/Opendoor Key."
echo "      (You need to set it for both OPENAI_API_KEY and ANTHROPIC_API_KEY)"
echo "   --------------------------------------------------------"
